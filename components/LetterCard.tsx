  ...
  if (isSent) {
    return (
      ...
      >
        ...
        <h2 className="text-3xl font-serif text-slate-200 mb-4 tracking-wide">
          Released
        </h2>
        <p className="text-slate-400 font-light max-w-md">
          Your message has been released into the digital void. Maybe, just
          maybe, the wind will carry it to Suki.
        </p>
      </div>
    );
  }
      ...
      <div className="p-8 md:p-12 relative">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="mb-8 p-3 rounded-full bg-white/5 border border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)]">
            <Heart
              className="text-indigo-300 w-6 h-6 animate-pulse"
              fill="rgba(165, 180, 252, 0.2)"
            />
          </div>

          <div className="w-16 h-px bg-indigo-500/30 mx-auto my-4" />

          <p className="font-serif text-lg md:text-xl leading-relaxed text-slate-300 whitespace-pre-line tracking-wide">
            "{CONFESSION_TEXT}"
          </p>

          {/* Optional: add a button to trigger handleRelease if you want */}
          {/* <button onClick={handleRelease} className="mt-10 ...">Release</button> */}
        </div>
      </div>
